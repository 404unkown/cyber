...
async function imagineCommand(sock, chatId, message) {
    try {
        ...
        // Ensure it's a valid image for WhatsApp
        // Sometimes the API returns the image with wrong headers
        // Just send it as image - WhatsApp will handle it
        await sock.sendMessage(chatId, {
            image: imageBuffer,
            caption: `🎨 Generated image for prompt: "${imagePrompt}"`,
            mimetype: 'image/jpeg' // Force JPEG mimetype
        }, {
            quoted: message
        });
